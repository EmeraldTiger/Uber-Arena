...
static void CG_RegisterSounds( void ) {
	...
	cgs.media.tyrantSound = trap_S_RegisterSound("sound/feedback/tyrant.wav", qtrue); // UBER ARENA 0.3
#ifdef MISSIONPACK
...
//		}
	...
	cgs.media.conserveSound = trap_S_RegisterSound("sound/items/conserve.wav", qfalse); // UBER ARENA 0.4
...
static void CG_RegisterGraphics( void ) {
	...
	cgs.media.inverseShader = trap_R_RegisterShader("powerups/inverse"); // UBER ARENA
	...
	cgs.media.medalTyrant = trap_R_RegisterShaderNoMip("medal_tyrant"); // UBER ARENA 0.3
