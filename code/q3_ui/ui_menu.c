...
#define MAIN_BANNER_MODEL				"models/powerups/instant/quad.md3"
#define MAIN_BANNER_MODEL_2				"models/powerups/instant/quad_ring.md3"
...
void MainMenu_Cache( void ) {
	...
	s_main.bannerModel2 = trap_R_RegisterModel(MAIN_BANNER_MODEL_2);
}
...
static void Main_MenuDraw( void ) {
	refdef_t		refdef;
	refEntity_t		ent, ent2, ent3;
	vec3_t			origin;
	vec3_t			angles, angles2, angles3;
	float			adjust;
	float			x, y, w, h;
	...
	refdef.fov_x = 60 * 2 + adjust;
	refdef.fov_y = 19.6875 * 2 + adjust;
	...
	adjust = 5.0 * ((float)uis.realtime / 100);
	...
	ent2 = ent;
	ent2.hModel = s_main.bannerModel2;
	ent2.origin[2] += 10;
	VectorSet(angles2, 173 - adjust, 113 + adjust, 141 + adjust);
	AnglesToAxis(angles2, ent2.axis);
	trap_R_AddRefEntityToScene(&ent2);
	ent3 = ent2;
	VectorSet(angles3, 157 + adjust, 154 + adjust, 169 - adjust);
	AnglesToAxis(angles3, ent3.axis);
	trap_R_AddRefEntityToScene(&ent3);
