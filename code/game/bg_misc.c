...
/*QUAKED item_armor_black (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
	*/
	{
		"item_armor_black",
		"sound/misc/ar2_pkup.wav",
		{ "models/powerups/armor/armor_black.md3",
		0, 0, 0 },
		/* icon */		"icons/iconr_black",
		/* pickup */	"Black Armor",
		25,
		IT_ARMOR,
		0,
...
/*QUAKED weapon_pendulumgun (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
	*/
	{
		"weapon_pendulumgun",
		"sound/misc/w_pkup.wav",
		{ "models/weapons2/pendulum/pendulum.md3",
		0, 0, 0 },
		/* icon */		"icons/iconw_pendulum",
		/* pickup */	"Pendulum Gun",
		10, // EMERALD: originally 20
		IT_WEAPON,
		WP_PENDULUMGUN,
...
// EMERALD: This is a special item that needs a bit of wonky coding
...
// This one also makes your next weapon pickup count as 2 pickups
/*QUAKED item_pouch_ultra (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
			*/
	{
		"item_pouch_ultra",
		"sound/items/pouch.wav",
		{ "models/powerups/pouch/pouch_ultra.md3",
		0, 0, 0 },
		/* icon */		"icons/icon_pouch_ultra",
		/* pickup */	"Ultra Weapon Pouch",
		3,
		IT_POUCH,
		0,
		/* precache */ "",
...
qboolean BG_CanItemBeGrabbed( int gametype, const entityState_t *ent, const playerState_t *ps, qboolean captureMode ) {
	...
	switch( item->giType ) {
	case IT_WEAPON:
		if (ps->eFlags & EF_MAXWEAPS && !(ps->powerups[PW_CONSERVATION])) {
			return qfalse;
		}
		return qtrue;
...
void BG_TouchFlip(playerState_t *ps, entityState_t *flip) {

	// Com_Printf("flip");
	// Com_Printf("%i", ps->viewangles[ROLL]);

	// ps->eFlags |= EF_UPSIDEDOWN;
}
...
void BG_PlayerStateToEntityState( playerState_t *ps, entityState_t *s, qboolean snap ) {
	...
	s->otherEntityNum = ps->stats[STAT_CLG_SHAFTEE_NUM2];
	s->otherEntityNum2 = ps->stats[STAT_CLG_SHAFTEE_NUM];
