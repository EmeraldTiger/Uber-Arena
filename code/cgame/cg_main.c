...
static cvarTable_t cvarTable[] = { // bk001129
	...
	{ &cg_UpsideDown, "cg_UpsideDown", "0.0", CVAR_ARCHIVE}
...
static void CG_RegisterSounds( void ) {
	...
	cgs.media.bounceSound = trap_S_RegisterSound("sound/player/bounce1.wav", qfalse);
...
//		}
	...
	cgs.media.tunerSound = trap_S_RegisterSound("sound/items/use_tuner.wav", qfalse); // emerald
...
static void CG_RegisterGraphics( void ) {
	...
	// UBER ARENA
	cgs.media.ionPlasmaBallShader = trap_R_RegisterShader("sprites/ionplasma1");
	...
	cgs.media.conservationShader = trap_R_RegisterShader("powerups/conservation");
	cgs.media.quadWeaponShader = trap_R_RegisterShader("powerups/quadWeapon" );
	cgs.media.conservationWeaponShader = trap_R_RegisterShader("powerups/conservationWeapon");
	cgs.media.battleSuitShader = trap_R_RegisterShader("powerups/battleSuit" );
	cgs.media.battleWeaponShader = trap_R_RegisterShader("powerups/battleWeapon" );
	cgs.media.invisShader = trap_R_RegisterShader("powerups/invisibility" );
	cgs.media.regenShader = trap_R_RegisterShader("powerups/regen" );
	cgs.media.hastePuffShader = trap_R_RegisterShader("hasteSmokePuff" );
	cgs.media.inverseShader = trap_R_RegisterShader("powerups/inverse");
	...
	cgs.media.uberWeaponEffectModel = trap_R_RegisterModel( "models/uber/uberfx.md3" );

	cgs.media.uberShotgunOrbModel = trap_R_RegisterModel("models/uber/ubershotgun.md3");
	cgs.media.uberGrenadeOrbModel = trap_R_RegisterModel("models/uber/ubergrenade.md3");
	cgs.media.uberRocketOrbModel = trap_R_RegisterModel("models/uber/uberrocket.md3");
	cgs.media.uberLightningOrbModel = trap_R_RegisterModel("models/uber/uberlightning.md3");
	cgs.media.uberPlasmaOrbModel = trap_R_RegisterModel("models/uber/uberplasma.md3");
	cgs.media.uberRailOrbModel = trap_R_RegisterModel("models/uber/uberrail.md3");
	cgs.media.uberBFGOrbModel = trap_R_RegisterModel("models/uber/uberbfg.md3");
