...
line 1844
;1842:
;1843:	// EMERALD: so does conservation!
;1844:	if (powerups & (1 << PW_CONSERVATION)) {
ADDRLP4 0
INDIRI4
CNSTI4 1024
BANDI4
...
EQI4 $844
line 1845
;1845:		trap_R_AddLightToScene(cent->lerpOrigin, 200 + (rand() & 31), 0.2f, 1, 0.2f);
ADDRLP4 8
ADDRGP4 rand
CALLI4
ASGNI4
...
line 1849
;1847:
;1848:	// flight plays a looped sound
;1849:	if ( powerups & ( 1 << PW_FLIGHT ) ) {
ADDRLP4 0
INDIRI4
CNSTI4 64
BANDI4
...
EQI4 $846
line 1850
;1850:		trap_S_AddLoopingSound( cent->currentState.number, cent->lerpOrigin, vec3_origin, cgs.media.flightSound );
ADDRLP4 8
ADDRFP4 0
INDIRP4
ASGNP4
...
line 1853
;1852:
;1853:	ci = &cgs.clientinfo[ cent->currentState.clientNum ];
ADDRLP4 4
CNSTI4 1708
ADDRFP4 0
INDIRP4
...
EQI4 $853
line 1857
;1857:			CG_PlayerFlag( cent, cgs.media.redFlagFlapSkin, torso );
ADDRFP4 0
INDIRP4
ARGP4
...
;1859:		else {
line 1860
;1860:			CG_TrailItem( cent, cgs.media.redFlagModel );
ADDRFP4 0
INDIRP4
ARGP4
...
LABELV $854
line 1862
;1862:		trap_R_AddLightToScene( cent->lerpOrigin, 200 + (rand()&31), 1.0, 0.2f, 0.2f );
ADDRLP4 8
ADDRGP4 rand
CALLI4
ASGNI4
...
;1864:
;1865:	// blueflag
;1866:	if ( powerups & ( 1 << PW_BLUEFLAG ) ) {
ADDRLP4 0
INDIRI4
CNSTI4 256
BANDI4
...
EQI4 $861
line 1868
;1868:			CG_PlayerFlag( cent, cgs.media.blueFlagFlapSkin, torso );
ADDRFP4 0
INDIRP4
ARGP4
...
;1870:		else {
line 1871
;1871:			CG_TrailItem( cent, cgs.media.blueFlagModel );
ADDRFP4 0
INDIRP4
ARGP4
...
LABELV $862
line 1873
;1873:		trap_R_AddLightToScene( cent->lerpOrigin, 200 + (rand()&31), 0.2f, 0.2f, 1.0 );
ADDRLP4 8
ADDRGP4 rand
CALLI4
ASGNI4
...
;1875:
;1876:	// neutralflag
;1877:	if ( powerups & ( 1 << PW_NEUTRALFLAG ) ) {
ADDRLP4 0
INDIRI4
CNSTI4 512
BANDI4
...
EQI4 $869
line 1879
;1879:			CG_PlayerFlag( cent, cgs.media.neutralFlagFlapSkin, torso );
ADDRFP4 0
INDIRP4
ARGP4
...
;1881:		else {
line 1882
;1882:			CG_TrailItem( cent, cgs.media.neutralFlagModel );
ADDRFP4 0
INDIRP4
ARGP4
...
LABELV $870
line 1884
;1884:		trap_R_AddLightToScene( cent->lerpOrigin, 200 + (rand()&31), 1.0, 1.0, 1.0 );
ADDRLP4 8
ADDRGP4 rand
CALLI4
ASGNI4
...
line 1888
;1886:
;1887:	// haste leaves smoke trails
;1888:	if ( powerups & ( 1 << PW_HASTE ) ) {
ADDRLP4 0
INDIRI4
CNSTI4 8
BANDI4
...
;1894:/*
;1895:===============
;1896:CG_PlayerFloatSprite
;1897:
;1898:Float a sprite over the player's head
;1899:===============
;1900:*/
;1901:static void CG_PlayerFloatSprite( centity_t *cent, qhandle_t shader ) {
line 1905
;1902:	int				rf;
;1903:	refEntity_t		ent;
;1904:
;1905:	if ( cent->currentState.number == cg.snap->ps.clientNum && !cg.renderingThirdPerson ) {
ADDRFP4 0
INDIRP4
INDIRI4
ADDRGP4 cg+36
...
NEI4 $878
line 1906
;1906:		rf = RF_THIRD_PERSON;		// only show in mirrors
ADDRLP4 140
CNSTI4 2
ASGNI4
line 1907
...
pop
line 1912
;1912:	VectorCopy( cent->lerpOrigin, ent.origin );
ADDRLP4 0+68
ADDRFP4 0
INDIRP4
CNSTI4 716
...
ASGNF4
line 1914
;1914:	ent.reType = RT_SPRITE;
ADDRLP4 0
CNSTI4 2
ASGNI4
line 1915
;1915:	ent.customShader = shader;
ADDRLP4 0+112
ADDRFP4 4
INDIRI4
ASGNI4
...
ASGNF4
line 1917
;1917:	ent.renderfx = rf;
ADDRLP4 0+4
ADDRLP4 140
INDIRI4
ASGNI4
line 1918
;1918:	ent.shaderRGBA[0] = 255;
ADDRLP4 0+116
CNSTU1 255
ASGNU1
line 1919
;1919:	ent.shaderRGBA[1] = 255;
ADDRLP4 0+116+1
CNSTU1 255
ASGNU1
line 1920
;1920:	ent.shaderRGBA[2] = 255;
ADDRLP4 0+116+2
CNSTU1 255
ASGNU1
line 1921
;1921:	ent.shaderRGBA[3] = 255;
ADDRLP4 0+116+3
CNSTU1 255
ASGNU1
line 1922
;1922:	trap_R_AddRefEntityToScene( &ent );
ADDRLP4 0
ARGP4
ADDRGP4 trap_R_AddRefEntityToScene
CALLV
...
;1927:/*
;1928:===============
;1929:CG_PlayerSprites
;1930:
;1931:Float sprites over the player's head
;1932:===============
;1933:*/
;1934:static void CG_PlayerSprites( centity_t *cent ) {
line 1939
;1935:	int		team;
;1936:
;1937:	// CG_Printf("%i", cent->currentState.eFlags & EF_UW_SHOTGUN);
;1938:
;1939:	if ( cent->currentState.eFlags & EF_CONNECTION ) {
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
EQI4 $896
line 1940
;1940:		CG_PlayerFloatSprite( cent, cgs.media.connectionShader );
ADDRFP4 0
INDIRP4
ARGP4
...
;1942:	}
;1943:
;1944:	if ( cent->currentState.eFlags & EF_TALK ) {
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
EQI4 $900
line 1945
;1945:		CG_PlayerFloatSprite( cent, cgs.media.balloonShader );
ADDRFP4 0
INDIRP4
ARGP4
...
;1947:	}
;1948:
;1949:	if ( cent->currentState.eFlags & EF_AWARD_IMPRESSIVE ) {
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
EQI4 $904
line 1950
;1950:		CG_PlayerFloatSprite( cent, cgs.media.medalImpressive );
ADDRFP4 0
INDIRP4
ARGP4
...
;1952:	}
;1953:
;1954:	if ( cent->currentState.eFlags & EF_AWARD_EXCELLENT ) {
ADDRLP4 4
CNSTI4 8
ASGNI4
ADDRFP4 0
...
EQI4 $908
line 1955
;1955:		CG_PlayerFloatSprite( cent, cgs.media.medalExcellent );
ADDRFP4 0
INDIRP4
ARGP4
...
;1957:	}
;1958:
;1959:	if ( cent->currentState.eFlags & EF_AWARD_GAUNTLET ) {
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
EQI4 $912
line 1960
;1960:		CG_PlayerFloatSprite( cent, cgs.media.medalGauntlet );
ADDRFP4 0
INDIRP4
ARGP4
...
;1962:	}
;1963:
;1964:	if ( cent->currentState.eFlags & EF_AWARD_DEFEND ) {
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
EQI4 $916
line 1965
;1965:		CG_PlayerFloatSprite( cent, cgs.media.medalDefend );
ADDRFP4 0
INDIRP4
ARGP4
...
;1967:	}
;1968:
;1969:	if ( cent->currentState.eFlags & EF_AWARD_ASSIST ) {
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
EQI4 $920
line 1970
;1970:		CG_PlayerFloatSprite( cent, cgs.media.medalAssist );
ADDRFP4 0
INDIRP4
ARGP4
...
;1972:	}
;1973:
;1974:	if ( cent->currentState.eFlags & EF_AWARD_CAP ) {
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
EQI4 $924
line 1975
;1975:		CG_PlayerFloatSprite( cent, cgs.media.medalCapture );
ADDRFP4 0
INDIRP4
ARGP4
...
;1977:	}
;1978:
;1979:	team = cgs.clientinfo[ cent->currentState.clientNum ].team;
ADDRLP4 0
CNSTI4 1708
ADDRFP4 0
INDIRP4
...
ASGNI4
line 1980
;1980:	if ( !(cent->currentState.eFlags & EF_DEAD) && 
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
LTI4 $930
line 1982
;1981:		cg.snap->ps.persistant[PERS_TEAM] == team &&
;1982:		cgs.gametype >= GT_TEAM) {
line 1983
;1983:		if (cg_drawFriend.integer) {
ADDRGP4 cg_drawFriend+12
INDIRI4
CNSTI4 0
EQI4 $895
line 1984
;1984:			CG_PlayerFloatSprite( cent, cgs.media.friendShader );
ADDRFP4 0
INDIRP4
ARGP4
...
;1990:/*
;1991:===============
;1992:CG_PlayerShadow
;1993:
;1994:Returns the Z component of the surface being shadowed
;1995:
;1996:  should it return a full plane instead of a Z?
;1997:===============
;1998:*/
;1999:#define	SHADOW_DISTANCE		128
;2000:static qboolean CG_PlayerShadow( centity_t *cent, float *shadowPlane ) {
line 2001
;2001:	vec3_t		end, mins = {-15, -15, 0}, maxs = {15, 15, 2};
ADDRLP4 72
ADDRGP4 $940
INDIRB
ASGNB 12
...
;2009:	}
;2010:
;2011:	// no shadows when invisible
;2012:	if ( cent->currentState.powerups & ( 1 << PW_INVIS ) ) {
ADDRFP4 0
INDIRP4
CNSTI4 188
ADDP4
...
;2014:	}
;2015:
;2016:	// send a trace down from the player to the ground
;2017:	VectorCopy( cent->lerpOrigin, end );
ADDRLP4 60
ADDRFP4 0
INDIRP4
CNSTI4 716
...
line 2020
;2019:
;2020:	trap_CM_BoxTrace( &trace, cent->lerpOrigin, end, mins, maxs, 0, MASK_PLAYERSOLID );
ADDRLP4 0
ARGP4
ADDRFP4 0
INDIRP4
...
line 2023
;2021:
;2022:	// no shadow if too high
;2023:	if ( trace.fraction == 1.0 || trace.startsolid || trace.allsolid ) {
ADDRLP4 0+8
INDIRF4
CNSTF4 1065353216
EQF4 $953
...
;2025:	}
;2026:
;2027:	*shadowPlane = trace.endpos[2] + 1;
ADDRFP4 4
INDIRP4
ADDRLP4 0+12+8
INDIRF4
...
line 2029
;2028:
;2029:	if ( cg_shadows.integer != 1 ) {	// no mark for stencil or projection shadows
ADDRGP4 cg_shadows+12
INDIRI4
CNSTI4 1
EQI4 $956
...
;2031:	}
;2032:
;2033:	// fade the shadow out with height
;2034:	alpha = 1.0 - trace.fraction;
ADDRLP4 56
CNSTF4 1065353216
ADDRLP4 0+8
INDIRF4
...
line 2041
;2035:
;2036:	// bk0101022 - hack / FPE - bogus planes?
;2037:	//assert( DotProduct( trace.plane.normal, trace.plane.normal ) != 0.0f ) 
;2038:
;2039:	// add the mark as a temporary, so it goes directly to the renderer
;2040:	// without taking a spot in the cg_marks array
;2041:	CG_ImpactMark( cgs.media.shadowMarkShader, trace.endpos, trace.plane.normal, 
...
pop
line 2044
;2042:		cent->pe.legs.yawAngle, alpha,alpha,alpha,1, qfalse, 24, qtrue );
;2043:
;2044:	return qtrue;
CNSTI4 1
RETI4
...
;2048:/*
;2049:===============
;2050:CG_PlayerSplash
;2051:
;2052:Draw a mark at the water surface
;2053:===============
;2054:*/
;2055:static void CG_PlayerSplash( centity_t *cent ) {
line 2061
;2056:	vec3_t		start, end;
;2057:	trace_t		trace;
;2058:	int			contents;
;2059:	polyVert_t	verts[4];
;2060:
;2061:	if ( !cg_shadows.integer ) {
ADDRGP4 cg_shadows+12
INDIRI4
CNSTI4 0
NEI4 $965
...
;2063:	}
;2064:
;2065:	VectorCopy( cent->lerpOrigin, end );
ADDRLP4 164
ADDRFP4 0
INDIRP4
CNSTI4 716
...
line 2070
;2067:
;2068:	// if the feet aren't in liquid, don't make a mark
;2069:	// this won't handle moving water brushes, but they wouldn't draw right anyway...
;2070:	contents = trap_CM_PointContents( end, 0 );
ADDRLP4 164
ARGP4
CNSTI4 0
ARGI4
...
ASGNI4
line 2071
;2071:	if ( !( contents & ( CONTENTS_WATER | CONTENTS_SLIME | CONTENTS_LAVA ) ) ) {
ADDRLP4 176
INDIRI4
CNSTI4 56
BANDI4
...
;2073:	}
;2074:
;2075:	VectorCopy( cent->lerpOrigin, start );
ADDRLP4 152
ADDRFP4 0
INDIRP4
CNSTI4 716
...
line 2079
;2077:
;2078:	// if the head isn't out of liquid, don't make a mark
;2079:	contents = trap_CM_PointContents( start, 0 );
ADDRLP4 152
ARGP4
CNSTI4 0
ARGI4
...
ASGNI4
line 2080
;2080:	if ( contents & ( CONTENTS_SOLID | CONTENTS_WATER | CONTENTS_SLIME | CONTENTS_LAVA ) ) {
ADDRLP4 176
INDIRI4
CNSTI4 57
BANDI4
...
;2082:	}
;2083:
;2084:	// trace down to find the surface
;2085:	trap_CM_BoxTrace( &trace, start, end, NULL, NULL, 0, ( CONTENTS_WATER | CONTENTS_SLIME | CONTENTS_LAVA ) );
ADDRLP4 96
ARGP4
ADDRLP4 152
ARGP4
...
;2089:	}
;2090:
;2091:	// create a mark polygon
;2092:	VectorCopy( trace.endpos, verts[0].xyz );
ADDRLP4 0
ADDRLP4 96+12
INDIRB
ASGNB 12
line 2093
;2093:	verts[0].xyz[0] -= 32;
ADDRLP4 0
ADDRLP4 0
INDIRF4
CNSTF4 1107296256
...
ASGNF4
line 2097
;2097:	verts[0].modulate[0] = 255;
ADDRLP4 0+20
CNSTU1 255
ASGNU1
line 2098
;2098:	verts[0].modulate[1] = 255;
ADDRLP4 0+20+1
CNSTU1 255
ASGNU1
line 2099
;2099:	verts[0].modulate[2] = 255;
ADDRLP4 0+20+2
CNSTU1 255
ASGNU1
line 2100
;2100:	verts[0].modulate[3] = 255;
ADDRLP4 0+20+3
CNSTU1 255
ASGNU1
line 2102
;2101:
;2102:	VectorCopy( trace.endpos, verts[1].xyz );
ADDRLP4 0+24
ADDRLP4 96+12
INDIRB
ASGNB 12
line 2103
;2103:	verts[1].xyz[0] -= 32;
ADDRLP4 0+24
ADDRLP4 0+24
INDIRF4
CNSTF4 1107296256
...
ASGNF4
line 2107
;2107:	verts[1].modulate[0] = 255;
ADDRLP4 0+24+20
CNSTU1 255
ASGNU1
line 2108
;2108:	verts[1].modulate[1] = 255;
ADDRLP4 0+24+20+1
CNSTU1 255
ASGNU1
line 2109
;2109:	verts[1].modulate[2] = 255;
ADDRLP4 0+24+20+2
CNSTU1 255
ASGNU1
line 2110
;2110:	verts[1].modulate[3] = 255;
ADDRLP4 0+24+20+3
CNSTU1 255
ASGNU1
line 2112
;2111:
;2112:	VectorCopy( trace.endpos, verts[2].xyz );
ADDRLP4 0+48
ADDRLP4 96+12
INDIRB
ASGNB 12
line 2113
;2113:	verts[2].xyz[0] += 32;
ADDRLP4 0+48
ADDRLP4 0+48
INDIRF4
CNSTF4 1107296256
...
ASGNF4
line 2117
;2117:	verts[2].modulate[0] = 255;
ADDRLP4 0+48+20
CNSTU1 255
ASGNU1
line 2118
;2118:	verts[2].modulate[1] = 255;
ADDRLP4 0+48+20+1
CNSTU1 255
ASGNU1
line 2119
;2119:	verts[2].modulate[2] = 255;
ADDRLP4 0+48+20+2
CNSTU1 255
ASGNU1
line 2120
;2120:	verts[2].modulate[3] = 255;
ADDRLP4 0+48+20+3
CNSTU1 255
ASGNU1
line 2122
;2121:
;2122:	VectorCopy( trace.endpos, verts[3].xyz );
ADDRLP4 0+72
ADDRLP4 96+12
INDIRB
ASGNB 12
line 2123
;2123:	verts[3].xyz[0] += 32;
ADDRLP4 0+72
ADDRLP4 0+72
INDIRF4
CNSTF4 1107296256
...
ASGNF4
line 2127
;2127:	verts[3].modulate[0] = 255;
ADDRLP4 0+72+20
CNSTU1 255
ASGNU1
line 2128
;2128:	verts[3].modulate[1] = 255;
ADDRLP4 0+72+20+1
CNSTU1 255
ASGNU1
line 2129
;2129:	verts[3].modulate[2] = 255;
ADDRLP4 0+72+20+2
CNSTU1 255
ASGNU1
line 2130
;2130:	verts[3].modulate[3] = 255;
ADDRLP4 0+72+20+3
CNSTU1 255
ASGNU1
line 2132
;2131:
;2132:	trap_R_AddPolyToScene( cgs.media.wakeMarkShader, 4, verts );
...
;2137:/*
;2138:===============
;2139:CG_AddRefEntityWithPowerups
;2140:
;2141:Adds a piece with modifications or duplications for powerups
;2142:Also called by CG_Missile for quad rockets, but nobody can tell...
;2143:===============
;2144:*/
;2145:void CG_AddRefEntityWithPowerups( refEntity_t *ent, entityState_t *state, int team ) {
line 2147
;2146:
;2147:	if (state->powerups & (1 << PW_INVIS)) {
ADDRFP4 4
INDIRP4
CNSTI4 188
ADDP4
...
EQI4 $1055
line 2148
;2148:		ent->customShader = cgs.media.invisShader;
ADDRFP4 0
INDIRP4
CNSTI4 112
ADDP4
...
LABELV $1055
line 2151
;2151:	else if (state->powerups & (1 << PW_RAMPAGE)) {
ADDRFP4 4
INDIRP4
CNSTI4 188
ADDP4
...
EQI4 $1059
line 2152
;2152:		ent->customShader = cgs.media.inverseShader;
ADDRFP4 0
INDIRP4
CNSTI4 112
ADDP4
...
LABELV $1078
line 2186
;2186:		if (state->powerups & (1 << PW_CONSERVATION)) {
ADDRFP4 4
INDIRP4
CNSTI4 188
ADDP4
...
EQI4 $1082
line 2187
;2187:			ent->customShader = cgs.media.conservationShader;
ADDRFP4 0
INDIRP4
CNSTI4 112
ADDP4
...
;2196:=================
;2197:*/
;2198:int CG_LightVerts( vec3_t normal, int numVerts, polyVert_t *verts )
;2199:{
line 2206
;2200:	int				i, j;
;2201:	float			incoming;
;2202:	vec3_t			ambientLight;
;2203:	vec3_t			lightDir;
;2204:	vec3_t			directedLight;
;2205:
;2206:	trap_R_LightForPoint( verts[0].xyz, ambientLight, directedLight, lightDir );
ADDRFP4 8
INDIRP4
ARGP4
ADDRLP4 12
...
LABELV $1087
line 2209
;2209:		incoming = DotProduct (normal, lightDir);
ADDRLP4 48
ADDRFP4 0
INDIRP4
ASGNP4
...
GTF4 $1093
line 2211
;2211:			verts[i].modulate[0] = ambientLight[0];
ADDRLP4 56
ADDRLP4 12
INDIRF4
ASGNF4
...
ASGNU1
line 2212
;2212:			verts[i].modulate[1] = ambientLight[1];
ADDRLP4 68
ADDRLP4 12+4
INDIRF4
ASGNF4
...
ASGNU1
line 2213
;2213:			verts[i].modulate[2] = ambientLight[2];
ADDRLP4 80
ADDRLP4 12+8
INDIRF4
ASGNF4
...
line 2217
;2216:		} 
;2217:		j = ( ambientLight[0] + incoming * directedLight[0] );
ADDRLP4 0
ADDRLP4 12
INDIRF4
ADDRLP4 8
...
line 2223
;2222:
;2223:		j = ( ambientLight[1] + incoming * directedLight[1] );
ADDRLP4 0
ADDRLP4 12+4
INDIRF4
ADDRLP4 8
...
line 2229
;2228:
;2229:		j = ( ambientLight[2] + incoming * directedLight[2] );
ADDRLP4 0
ADDRLP4 12+8
INDIRF4
ADDRLP4 8
...
;2243:===============
;2244:*/
;2245:void CG_Player( centity_t *cent ) {
line 2270
;2246:	clientInfo_t	*ci;
;2247:	refEntity_t		legs;
;2248:	refEntity_t		torso;
;2249:	refEntity_t		head;
;2250:	int				clientNum;
;2251:	int				renderfx;
;2252:	qboolean		shadow;
;2253:	float			shadowPlane;
;2254:	refEntity_t		orbs;
;2255:	vec3_t			spinAngles;
;2256:	entityState_t	*es;
;2257:	int				copy;
;2258:#ifdef MISSIONPACK
;2259:	refEntity_t		skull;
;2260:	refEntity_t		powerup;
;2261:	int				t;
;2262:	float			c;
;2263:	float			angle;
;2264:	vec3_t			dir, angles;
;2265:#endif
;2266:
;2267:	// the client number is stored in clientNum.  It can't be derived
;2268:	// from the entity number, because a single client may have
;2269:	// multiple corpses on the level using the same clientinfo
;2270:	clientNum = cent->currentState.clientNum;
ADDRLP4 428
ADDRFP4 0
INDIRP4
CNSTI4 168
...
ASGNI4
line 2271
;2271:	if ( clientNum < 0 || clientNum >= MAX_CLIENTS ) {
ADDRLP4 428
INDIRI4
CNSTI4 0
LTI4 $1119
...
LABELV $1119
line 2272
;2272:		CG_Error( "Bad clientNum on player entity");
ADDRGP4 $1120
ARGP4
ADDRGP4 CG_Error
CALLV
...
LABELV $1117
line 2274
;2274:	ci = &cgs.clientinfo[ clientNum ];
ADDRLP4 280
CNSTI4 1708
ADDRLP4 428
INDIRI4
...
line 2278
;2275:
;2276:	// it is possible to see corpses from disconnected players that may
;2277:	// not have valid clientinfo
;2278:	if ( !ci->infoValid ) {
ADDRLP4 280
INDIRP4
INDIRI4
CNSTI4 0
...
;2280:	}
;2281:
;2282:	// get the player model information
;2283:	renderfx = 0;
ADDRLP4 424
CNSTI4 0
ASGNI4
line 2284
;2284:	if ( cent->currentState.number == cg.snap->ps.clientNum) {
ADDRFP4 0
INDIRP4
INDIRI4
ADDRGP4 cg+36
...
NEI4 $1124
line 2285
;2285:		if (!cg.renderingThirdPerson) {
ADDRGP4 cg+111732
INDIRI4
CNSTI4 0
NEI4 $1127
line 2286
;2286:			renderfx = RF_THIRD_PERSON;			// only draw in mirrors
ADDRLP4 424
CNSTI4 2
ASGNI4
line 2287
...
;2293:
;2294:
;2295:	memset( &legs, 0, sizeof(legs) );
ADDRLP4 140
ARGP4
CNSTI4 0
ARGI4
...
pop
line 2296
;2296:	memset( &torso, 0, sizeof(torso) );
ADDRLP4 0
ARGP4
CNSTI4 0
ARGI4
...
pop
line 2297
;2297:	memset( &head, 0, sizeof(head) );
ADDRLP4 284
ARGP4
CNSTI4 0
ARGI4
...
line 2300
;2298:
;2299:	// get the rotation information
;2300:	CG_PlayerAngles( cent, legs.axis, torso.axis, head.axis );
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 140+28
...
line 2303
;2301:	
;2302:	// get the animation state (after rotation, to allow feet shuffle)
;2303:	CG_PlayerAnimation( cent, &legs.oldframe, &legs.frame, &legs.backlerp,
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 140+96
...
pop
line 2307
;2304:		 &torso.oldframe, &torso.frame, &torso.backlerp );
;2305:
;2306:	// add the talk baloon or disconnect icon
;2307:	CG_PlayerSprites( cent );
ADDRFP4 0
INDIRP4
ARGP4
...
;2308:
;2309:	// add the shadow
;2310:	shadow = CG_PlayerShadow( cent, &shadowPlane );
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 432
...
line 2313
;2311:
;2312:	// add a water splash if partially in and out of water
;2313:	CG_PlayerSplash( cent );
ADDRFP4 0
INDIRP4
ARGP4
...
line 2315
;2314:
;2315:	if ( cg_shadows.integer == 3 && shadow ) {
ADDRGP4 cg_shadows+12
INDIRI4
CNSTI4 3
NEI4 $1142
...
LABELV $1142
line 2318
;2318:	renderfx |= RF_LIGHTING_ORIGIN;			// use the same origin for all
ADDRLP4 424
ADDRLP4 424
INDIRI4
CNSTI4 128
...
ASGNI4
line 2327
;2319:#ifdef MISSIONPACK
;2320:	if( cgs.gametype == GT_HARVESTER ) {
;2321:		CG_PlayerTokens( cent, renderfx );
;2322:	}
;2323:#endif
;2324:	//
;2325:	// add the legs
;2326:	//
;2327:	legs.hModel = ci->legsModel;
ADDRLP4 140+8
ADDRLP4 280
INDIRP4
CNSTI4 516
...
ASGNI4
line 2328
;2328:	legs.customSkin = ci->legsSkin;
ADDRLP4 140+108
ADDRLP4 280
INDIRP4
CNSTI4 520
...
line 2330
;2329:
;2330:	VectorCopy( cent->lerpOrigin, legs.origin );
ADDRLP4 140+68
ADDRFP4 0
INDIRP4
CNSTI4 716
...
line 2332
;2331:
;2332:	VectorCopy( cent->lerpOrigin, legs.lightingOrigin );
ADDRLP4 140+12
ADDRFP4 0
INDIRP4
CNSTI4 716
...
ASGNB 12
line 2333
;2333:	legs.shadowPlane = shadowPlane;
ADDRLP4 140+24
ADDRLP4 432
INDIRF4
ASGNF4
line 2334
;2334:	legs.renderfx = renderfx;
ADDRLP4 140+4
ADDRLP4 424
INDIRI4
ASGNI4
line 2335
;2335:	VectorCopy (legs.origin, legs.oldorigin);	// don't positionally lerp at all
ADDRLP4 140+84
ADDRLP4 140+68
INDIRB
ASGNB 12
line 2337
;2336:
;2337:	CG_AddRefEntityWithPowerups( &legs, &cent->currentState, ci->team );
ADDRLP4 140
ARGP4
ADDRFP4 0
INDIRP4
...
line 2340
;2338:
;2339:	// if the model failed, allow the default nullmodel to be displayed
;2340:	if (!legs.hModel) {
ADDRLP4 140+8
INDIRI4
CNSTI4 0
...
;2345:	// add the torso
;2346:	//
;2347:	torso.hModel = ci->torsoModel;
ADDRLP4 0+8
ADDRLP4 280
INDIRP4
CNSTI4 524
...
;2350:	}
;2351:
;2352:	torso.customSkin = ci->torsoSkin;
ADDRLP4 0+108
ADDRLP4 280
INDIRP4
CNSTI4 528
...
line 2354
;2353:
;2354:	VectorCopy( cent->lerpOrigin, torso.lightingOrigin );
ADDRLP4 0+12
ADDRFP4 0
INDIRP4
CNSTI4 716
...
line 2356
;2355:
;2356:	CG_PositionRotatedEntityOnTag( &torso, &legs, ci->legsModel, "tag_torso");
ADDRLP4 0
ARGP4
ADDRLP4 140
ARGP4
...
line 2358
;2357:
;2358:	torso.shadowPlane = shadowPlane;
ADDRLP4 0+24
ADDRLP4 432
INDIRF4
ASGNF4
line 2359
;2359:	torso.renderfx = renderfx;
ADDRLP4 0+4
ADDRLP4 424
INDIRI4
ASGNI4
line 2361
;2360:
;2361:	CG_AddRefEntityWithPowerups( &torso, &cent->currentState, ci->team );
ADDRLP4 0
ARGP4
ADDRFP4 0
INDIRP4
...
line 2567
;2362:
;2363:#ifdef MISSIONPACK
;2364:	if ( cent->currentState.eFlags & EF_KAMIKAZE ) {
;2365:
;2366:		memset( &skull, 0, sizeof(skull) );
;2367:
;2368:		VectorCopy( cent->lerpOrigin, skull.lightingOrigin );
;2369:		skull.shadowPlane = shadowPlane;
;2370:		skull.renderfx = renderfx;
;2371:
;2372:		if ( cent->currentState.eFlags & EF_DEAD ) {
;2373:			// one skull bobbing above the dead body
;2374:			angle = ((cg.time / 7) & 255) * (M_PI * 2) / 255;
;2375:			if (angle > M_PI * 2)
;2376:				angle -= (float)M_PI * 2;
;2377:			dir[0] = sin(angle) * 20;
;2378:			dir[1] = cos(angle) * 20;
;2379:			angle = ((cg.time / 4) & 255) * (M_PI * 2) / 255;
;2380:			dir[2] = 15 + sin(angle) * 8;
;2381:			VectorAdd(torso.origin, dir, skull.origin);
;2382:			
;2383:			dir[2] = 0;
;2384:			VectorCopy(dir, skull.axis[1]);
;2385:			VectorNormalize(skull.axis[1]);
;2386:			VectorSet(skull.axis[2], 0, 0, 1);
;2387:			CrossProduct(skull.axis[1], skull.axis[2], skull.axis[0]);
;2388:
;2389:			skull.hModel = cgs.media.kamikazeHeadModel;
;2390:			trap_R_AddRefEntityToScene( &skull );
;2391:			skull.hModel = cgs.media.kamikazeHeadTrail;
;2392:			trap_R_AddRefEntityToScene( &skull );
;2393:		}
;2394:		else {
;2395:			// three skulls spinning around the player
;2396:			angle = ((cg.time / 4) & 255) * (M_PI * 2) / 255;
;2397:			dir[0] = cos(angle) * 20;
;2398:			dir[1] = sin(angle) * 20;
;2399:			dir[2] = cos(angle) * 20;
;2400:			VectorAdd(torso.origin, dir, skull.origin);
;2401:
;2402:			angles[0] = sin(angle) * 30;
;2403:			angles[1] = (angle * 180 / M_PI) + 90;
;2404:			if (angles[1] > 360)
;2405:				angles[1] -= 360;
;2406:			angles[2] = 0;
;2407:			AnglesToAxis( angles, skull.axis );
;2408:
;2409:			/*
;2410:			dir[2] = 0;
;2411:			VectorInverse(dir);
;2412:			VectorCopy(dir, skull.axis[1]);
;2413:			VectorNormalize(skull.axis[1]);
;2414:			VectorSet(skull.axis[2], 0, 0, 1);
;2415:			CrossProduct(skull.axis[1], skull.axis[2], skull.axis[0]);
;2416:			*/
;2417:
;2418:			skull.hModel = cgs.media.kamikazeHeadModel;
;2419:			trap_R_AddRefEntityToScene( &skull );
;2420:			// flip the trail because this skull is spinning in the other direction
;2421:			VectorInverse(skull.axis[1]);
;2422:			skull.hModel = cgs.media.kamikazeHeadTrail;
;2423:			trap_R_AddRefEntityToScene( &skull );
;2424:
;2425:			angle = ((cg.time / 4) & 255) * (M_PI * 2) / 255 + M_PI;
;2426:			if (angle > M_PI * 2)
;2427:				angle -= (float)M_PI * 2;
;2428:			dir[0] = sin(angle) * 20;
;2429:			dir[1] = cos(angle) * 20;
;2430:			dir[2] = cos(angle) * 20;
;2431:			VectorAdd(torso.origin, dir, skull.origin);
;2432:
;2433:			angles[0] = cos(angle - 0.5 * M_PI) * 30;
;2434:			angles[1] = 360 - (angle * 180 / M_PI);
;2435:			if (angles[1] > 360)
;2436:				angles[1] -= 360;
;2437:			angles[2] = 0;
;2438:			AnglesToAxis( angles, skull.axis );
;2439:
;2440:			/*
;2441:			dir[2] = 0;
;2442:			VectorCopy(dir, skull.axis[1]);
;2443:			VectorNormalize(skull.axis[1]);
;2444:			VectorSet(skull.axis[2], 0, 0, 1);
;2445:			CrossProduct(skull.axis[1], skull.axis[2], skull.axis[0]);
;2446:			*/
;2447:
;2448:			skull.hModel = cgs.media.kamikazeHeadModel;
;2449:			trap_R_AddRefEntityToScene( &skull );
;2450:			skull.hModel = cgs.media.kamikazeHeadTrail;
;2451:			trap_R_AddRefEntityToScene( &skull );
;2452:
;2453:			angle = ((cg.time / 3) & 255) * (M_PI * 2) / 255 + 0.5 * M_PI;
;2454:			if (angle > M_PI * 2)
;2455:				angle -= (float)M_PI * 2;
;2456:			dir[0] = sin(angle) * 20;
;2457:			dir[1] = cos(angle) * 20;
;2458:			dir[2] = 0;
;2459:			VectorAdd(torso.origin, dir, skull.origin);
;2460:			
;2461:			VectorCopy(dir, skull.axis[1]);
;2462:			VectorNormalize(skull.axis[1]);
;2463:			VectorSet(skull.axis[2], 0, 0, 1);
;2464:			CrossProduct(skull.axis[1], skull.axis[2], skull.axis[0]);
;2465:
;2466:			skull.hModel = cgs.media.kamikazeHeadModel;
;2467:			trap_R_AddRefEntityToScene( &skull );
;2468:			skull.hModel = cgs.media.kamikazeHeadTrail;
;2469:			trap_R_AddRefEntityToScene( &skull );
;2470:		}
;2471:	}
;2472:
;2473:	if ( cent->currentState.powerups & ( 1 << PW_GUARD ) ) {
;2474:		memcpy(&powerup, &torso, sizeof(torso));
;2475:		powerup.hModel = cgs.media.guardPowerupModel;
;2476:		powerup.frame = 0;
;2477:		powerup.oldframe = 0;
;2478:		powerup.customSkin = 0;
;2479:		trap_R_AddRefEntityToScene( &powerup );
;2480:	}
;2481:	if ( cent->currentState.powerups & ( 1 << PW_SCOUT ) ) {
;2482:		memcpy(&powerup, &torso, sizeof(torso));
;2483:		powerup.hModel = cgs.media.scoutPowerupModel;
;2484:		powerup.frame = 0;
;2485:		powerup.oldframe = 0;
;2486:		powerup.customSkin = 0;
;2487:		trap_R_AddRefEntityToScene( &powerup );
;2488:	}
;2489:	if ( cent->currentState.powerups & ( 1 << PW_DOUBLER ) ) {
;2490:		memcpy(&powerup, &torso, sizeof(torso));
;2491:		powerup.hModel = cgs.media.doublerPowerupModel;
;2492:		powerup.frame = 0;
;2493:		powerup.oldframe = 0;
;2494:		powerup.customSkin = 0;
;2495:		trap_R_AddRefEntityToScene( &powerup );
;2496:	}
;2497:	if ( cent->currentState.powerups & ( 1 << PW_AMMOREGEN ) ) {
;2498:		memcpy(&powerup, &torso, sizeof(torso));
;2499:		powerup.hModel = cgs.media.ammoRegenPowerupModel;
;2500:		powerup.frame = 0;
;2501:		powerup.oldframe = 0;
;2502:		powerup.customSkin = 0;
;2503:		trap_R_AddRefEntityToScene( &powerup );
;2504:	}
;2505:	if ( cent->currentState.powerups & ( 1 << PW_INVULNERABILITY ) ) {
;2506:		if ( !ci->invulnerabilityStartTime ) {
;2507:			ci->invulnerabilityStartTime = cg.time;
;2508:		}
;2509:		ci->invulnerabilityStopTime = cg.time;
;2510:	}
;2511:	else {
;2512:		ci->invulnerabilityStartTime = 0;
;2513:	}
;2514:	if ( (cent->currentState.powerups & ( 1 << PW_INVULNERABILITY ) ) ||
;2515:		cg.time - ci->invulnerabilityStopTime < 250 ) {
;2516:
;2517:		memcpy(&powerup, &torso, sizeof(torso));
;2518:		powerup.hModel = cgs.media.invulnerabilityPowerupModel;
;2519:		powerup.customSkin = 0;
;2520:		// always draw
;2521:		powerup.renderfx &= ~RF_THIRD_PERSON;
;2522:		VectorCopy(cent->lerpOrigin, powerup.origin);
;2523:
;2524:		if ( cg.time - ci->invulnerabilityStartTime < 250 ) {
;2525:			c = (float) (cg.time - ci->invulnerabilityStartTime) / 250;
;2526:		}
;2527:		else if (cg.time - ci->invulnerabilityStopTime < 250 ) {
;2528:			c = (float) (250 - (cg.time - ci->invulnerabilityStopTime)) / 250;
;2529:		}
;2530:		else {
;2531:			c = 1;
;2532:		}
;2533:		VectorSet( powerup.axis[0], c, 0, 0 );
;2534:		VectorSet( powerup.axis[1], 0, c, 0 );
;2535:		VectorSet( powerup.axis[2], 0, 0, c );
;2536:		trap_R_AddRefEntityToScene( &powerup );
;2537:	}
;2538:
;2539:	t = cg.time - ci->medkitUsageTime;
;2540:	if ( ci->medkitUsageTime && t < 500 ) {
;2541:		memcpy(&powerup, &torso, sizeof(torso));
;2542:		powerup.hModel = cgs.media.medkitUsageModel;
;2543:		powerup.customSkin = 0;
;2544:		// always draw
;2545:		powerup.renderfx &= ~RF_THIRD_PERSON;
;2546:		VectorClear(angles);
;2547:		AnglesToAxis(angles, powerup.axis);
;2548:		VectorCopy(cent->lerpOrigin, powerup.origin);
;2549:		powerup.origin[2] += -24 + (float) t * 80 / 500;
;2550:		if ( t > 400 ) {
;2551:			c = (float) (t - 1000) * 0xff / 100;
;2552:			powerup.shaderRGBA[0] = 0xff - c;
;2553:			powerup.shaderRGBA[1] = 0xff - c;
;2554:			powerup.shaderRGBA[2] = 0xff - c;
;2555:			powerup.shaderRGBA[3] = 0xff - c;
;2556:		}
;2557:		else {
;2558:			powerup.shaderRGBA[0] = 0xff;
;2559:			powerup.shaderRGBA[1] = 0xff;
;2560:			powerup.shaderRGBA[2] = 0xff;
;2561:			powerup.shaderRGBA[3] = 0xff;
;2562:		}
;2563:		trap_R_AddRefEntityToScene( &powerup );
;2564:	}
;2565:#endif // MISSIONPACK
;2566:
;2567:	if (cent->currentState.eFlags & EF_UW_ROCKET) {
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
line 2571
;2570:
;2571:	if (cent->currentState.weapon == WP_SHOTGUN && (cent->currentState.eFlags & EF_UW_SHOTGUN)) {
ADDRLP4 608
ADDRFP4 0
INDIRP4
ASGNP4
...
EQI4 $1167
line 2573
;2572:		// CG_Printf("can you read this");
;2573:		memcpy(&orbs, &torso, sizeof(torso));
ADDRLP4 436
ARGP4
ADDRLP4 0
ARGP4
...
pop
line 2574
;2574:		orbs.hModel = cgs.media.uberShotgunOrbModel;
ADDRLP4 436+8
ADDRGP4 cgs+152340+508
INDIRI4
ASGNI4
line 2575
;2575:		orbs.customSkin = 0;
ADDRLP4 436+108
CNSTI4 0
ASGNI4
line 2576
;2576:		VectorCopy(torso.origin, orbs.origin);
ADDRLP4 436+68
ADDRLP4 0+68
INDIRB
ASGNB 12
line 2577
;2577:		spinAngles[1] = cg.time * -0.2;
ADDRLP4 580+4
CNSTF4 3192704205
ADDRGP4 cg+111708
INDIRI4
...
ASGNF4
line 2578
;2578:		AnglesToAxis(spinAngles, orbs.axis);
ADDRLP4 580
ARGP4
ADDRLP4 436+28
ARGP4
...
pop
line 2579
;2579:		trap_R_AddRefEntityToScene(&orbs);
ADDRLP4 436
ARGP4
ADDRGP4 trap_R_AddRefEntityToScene
CALLV
...
line 2645
;2581:
;2582:	/* if (cent->currentState.weapon == WP_GRENADE_LAUNCHER && (cg.snap->uberGLUsers[cent->currentState.clientNum] == qtrue)) {
;2583:		memcpy(&orbs, &torso, sizeof(torso));
;2584:		orbs.hModel = cgs.media.uberGrenadeOrbModel;
;2585:		orbs.customSkin = 0;
;2586:		VectorCopy(torso.origin, orbs.origin);
;2587:		spinAngles[1] = cg.time * -0.2;
;2588:		AnglesToAxis(spinAngles, orbs.axis);
;2589:		trap_R_AddRefEntityToScene(&orbs);
;2590:	}
;2591:
;2592:	if (cent->currentState.weapon == WP_ROCKET_LAUNCHER && (cg.snap->uberRLUsers[cent->currentState.clientNum] == qtrue)) {
;2593:		memcpy(&orbs, &torso, sizeof(torso));
;2594:		orbs.hModel = cgs.media.uberRocketOrbModel;
;2595:		orbs.customSkin = 0;
;2596:		VectorCopy(torso.origin, orbs.origin);
;2597:		spinAngles[1] = cg.time * -0.2;
;2598:		AnglesToAxis(spinAngles, orbs.axis);
;2599:		trap_R_AddRefEntityToScene(&orbs);
;2600:	} */
;2601:
;2602:	/* if (cent->currentState.weapon == WP_LIGHTNING && (cent->currentState.eFlags & EF_UW_LIGHTNING)) {
;2603:		memcpy(&orbs, &torso, sizeof(torso));
;2604:		orbs.hModel = cgs.media.uberLightningOrbModel;
;2605:		orbs.customSkin = 0;
;2606:		VectorCopy(torso.origin, orbs.origin);
;2607:		spinAngles[1] = cg.time * -0.2;
;2608:		AnglesToAxis(spinAngles, orbs.axis);
;2609:		trap_R_AddRefEntityToScene(&orbs);
;2610:	}
;2611:
;2612:	if (cent->currentState.weapon == WP_PLASMAGUN && (cent->currentState.eFlags & EF_UW_PLASMA)) {
;2613:		memcpy(&orbs, &torso, sizeof(torso));
;2614:		orbs.hModel = cgs.media.uberPlasmaOrbModel;
;2615:		orbs.customSkin = 0;
;2616:		VectorCopy(torso.origin, orbs.origin);
;2617:		spinAngles[1] = cg.time * -0.2;
;2618:		AnglesToAxis(spinAngles, orbs.axis);
;2619:		trap_R_AddRefEntityToScene(&orbs);
;2620:	}
;2621:
;2622:	if (cent->currentState.weapon == WP_RAILGUN && (cent->currentState.eFlags & EF_UW_RAIL)) {
;2623:		memcpy(&orbs, &torso, sizeof(torso));
;2624:		orbs.hModel = cgs.media.uberRailOrbModel;
;2625:		orbs.customSkin = 0;
;2626:		VectorCopy(torso.origin, orbs.origin);
;2627:		spinAngles[1] = cg.time * -0.2;
;2628:		AnglesToAxis(spinAngles, orbs.axis);
;2629:		trap_R_AddRefEntityToScene(&orbs);
;2630:	}
;2631:
;2632:	if (cent->currentState.weapon == WP_BFG && (cent->currentState.eFlags & EF_UW_BFG)) {
;2633:		memcpy(&orbs, &torso, sizeof(torso));
;2634:		orbs.hModel = cgs.media.uberBFGOrbModel;
;2635:		orbs.customSkin = 0;
;2636:		VectorCopy(torso.origin, orbs.origin);
;2637:		spinAngles[1] = cg.time * -0.2;
;2638:		AnglesToAxis(spinAngles, orbs.axis);
;2639:		trap_R_AddRefEntityToScene(&orbs);
;2640:	} */
;2641:
;2642:	//
;2643:	// add the head
;2644:	//
;2645:	head.hModel = ci->headModel;
ADDRLP4 284+8
ADDRLP4 280
INDIRP4
CNSTI4 532
...
line 2649
;2648:	}
;2649:	head.customSkin = ci->headSkin;
ADDRLP4 284+108
ADDRLP4 280
INDIRP4
CNSTI4 536
...
line 2651
;2650:
;2651:	VectorCopy( cent->lerpOrigin, head.lightingOrigin );
ADDRLP4 284+12
ADDRFP4 0
INDIRP4
CNSTI4 716
...
line 2653
;2652:
;2653:	CG_PositionRotatedEntityOnTag( &head, &torso, ci->torsoModel, "tag_head");
ADDRLP4 284
ARGP4
ADDRLP4 0
ARGP4
...
line 2655
;2654:
;2655:	head.shadowPlane = shadowPlane;
ADDRLP4 284+24
ADDRLP4 432
INDIRF4
ASGNF4
line 2656
;2656:	head.renderfx = renderfx;
ADDRLP4 284+4
ADDRLP4 424
INDIRI4
ASGNI4
line 2658
;2657:
;2658:	CG_AddRefEntityWithPowerups( &head, &cent->currentState, ci->team );
ADDRLP4 284
ARGP4
ADDRFP4 0
INDIRP4
...
;2661:	CG_BreathPuffs(cent, &head);
;2662:
;2663:	CG_DustTrail(cent);
;2664:#endif
;2665:
;2666:	//
;2667:	// add the gun / barrel / flash
;2668:	//
;2669:	CG_AddPlayerWeapon( &torso, NULL, cent, ci->team );
ADDRLP4 0
ARGP4
CNSTP4 0
ARGP4
...
line 2672
;2670:
;2671:	// add powerups floating behind the player
;2672:	CG_PlayerPowerups( cent, &torso );
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 0
...
;2678:/*
;2679:===============
;2680:CG_ResetPlayerEntity
;2681:
;2682:A player just came into view or teleported, so reset all animation info
;2683:===============
;2684:*/
;2685:void CG_ResetPlayerEntity( centity_t *cent ) {
line 2686
;2686:	cent->errorTime = -99999;		// guarantee no error decay added
ADDRFP4 0
INDIRP4
CNSTI4 648
ADDP4
...
line 2689
;2688:
;2689:	CG_ClearLerpFrame( &cgs.clientinfo[ cent->currentState.clientNum ], &cent->pe.legs, cent->currentState.legsAnim );
ADDRLP4 0
ADDRFP4 0
INDIRP4
ASGNP4
...
pop
line 2690
;2690:	CG_ClearLerpFrame( &cgs.clientinfo[ cent->currentState.clientNum ], &cent->pe.torso, cent->currentState.torsoAnim );
ADDRLP4 4
ADDRFP4 0
INDIRP4
ASGNP4
...
line 2692
;2691:
;2692:	BG_EvaluateTrajectory( &cent->currentState.pos, cg.time, cent->lerpOrigin );
ADDRLP4 8
ADDRFP4 0
INDIRP4
ASGNP4
...
pop
line 2693
;2693:	BG_EvaluateTrajectory( &cent->currentState.apos, cg.time, cent->lerpAngles );
ADDRLP4 12
ADDRFP4 0
INDIRP4
ASGNP4
...
line 2695
;2694:
;2695:	VectorCopy( cent->lerpOrigin, cent->rawOrigin );
ADDRLP4 16
ADDRFP4 0
INDIRP4
ASGNP4
...
ASGNB 12
line 2696
;2696:	VectorCopy( cent->lerpAngles, cent->rawAngles );
ADDRLP4 20
ADDRFP4 0
INDIRP4
ASGNP4
...
line 2698
;2697:
;2698:	memset( &cent->pe.legs, 0, sizeof( cent->pe.legs ) );
ADDRFP4 0
INDIRP4
CNSTI4 464
ADDP4
...
pop
line 2699
;2699:	cent->pe.legs.yawAngle = cent->rawAngles[YAW];
ADDRLP4 24
ADDRFP4 0
INDIRP4
ASGNP4
...
ASGNF4
line 2700
;2700:	cent->pe.legs.yawing = qfalse;
ADDRFP4 0
INDIRP4
CNSTI4 488
ADDP4
...
ASGNI4
line 2701
;2701:	cent->pe.legs.pitchAngle = 0;
ADDRFP4 0
INDIRP4
CNSTI4 492
ADDP4
...
ASGNF4
line 2702
;2702:	cent->pe.legs.pitching = qfalse;
ADDRFP4 0
INDIRP4
CNSTI4 496
ADDP4
...
line 2704
;2703:
;2704:	memset( &cent->pe.torso, 0, sizeof( cent->pe.legs ) );
ADDRFP4 0
INDIRP4
CNSTI4 512
ADDP4
...
pop
line 2705
;2705:	cent->pe.torso.yawAngle = cent->rawAngles[YAW];
ADDRLP4 28
ADDRFP4 0
INDIRP4
ASGNP4
...
ASGNF4
line 2706
;2706:	cent->pe.torso.yawing = qfalse;
ADDRFP4 0
INDIRP4
CNSTI4 536
ADDP4
...
ASGNI4
line 2707
;2707:	cent->pe.torso.pitchAngle = cent->rawAngles[PITCH];
ADDRLP4 32
ADDRFP4 0
INDIRP4
ASGNP4
...
ASGNF4
line 2708
;2708:	cent->pe.torso.pitching = qfalse;
ADDRFP4 0
INDIRP4
CNSTI4 544
ADDP4
...
line 2710
;2709:
;2710:	if ( cg_debugPosition.integer ) {
ADDRGP4 cg_debugPosition+12
INDIRI4
CNSTI4 0
EQI4 $1192
line 2711
;2711:		CG_Printf("%i ResetPlayerEntity yaw=%i\n", cent->currentState.number, cent->pe.torso.yawAngle );
ADDRGP4 $1195
ARGP4
ADDRLP4 36
ADDRFP4 0
