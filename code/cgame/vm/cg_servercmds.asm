...
;1078:	}
;1079:
;1080:	/* if (!strcmp(cmd, "ubershotgun")) {
;1081:		cg.predictedPlayerState.eFlags |= EF_UW_ROCKET;
;1082:		return;
;1083:	} */
;1084:
;1085:	CG_Printf( "Unknown client game command: %s\n", cmd );
ADDRGP4 $583
ARGP4
ADDRLP4 0
INDIRP4
...
;1089:/*
;1090:====================
;1091:CG_ExecuteNewServerCommands
;1092:
;1093:Execute all of the server commands that were received along
;1094:with this this snapshot.
;1095:====================
;1096:*/
;1097:void CG_ExecuteNewServerCommands( int latestSequence ) {
ADDRGP4 $586
JUMPV
LABELV $585
line 1098
;1098:	while ( cgs.serverCommandSequence < latestSequence ) {
line 1099
;1099:		if ( trap_GetServerCommand( ++cgs.serverCommandSequence ) ) {
ADDRLP4 0
ADDRGP4 cgs+31444
ASGNP4
ADDRLP4 4
