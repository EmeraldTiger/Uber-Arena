...
// UBER ARENA bitflags for uberweapons
#define UBER_SHOTGUN_ORB	0x00000001
#define UBER_GRENADE_ORB	0x00000002
#define UBER_ROCKET_ORB		0x00000004
#define UBER_LIGHTNING_ORB	0x00000008
#define UBER_PLASMA_ORB		0x00000010
#define UBER_RAIL_ORB		0x00000020
#define UBER_BFG_ORB		0x00000040
...
typedef struct weaponInfo_s {
	...
	sfxHandle_t		trackSound; // UBER ARENA
	qboolean		tracking;
...
typedef struct {
	...
	qhandle_t	conservationShader;
	qhandle_t	conservationWeaponShader;
	...
	qhandle_t	uberWeaponEffectModel;

	qhandle_t	uberShotgunOrbModel;
	qhandle_t	uberGrenadeOrbModel;
	qhandle_t	uberRocketOrbModel;
	qhandle_t	uberLightningOrbModel;
	qhandle_t	uberPlasmaOrbModel;
	qhandle_t	uberRailOrbModel;
	qhandle_t	uberBFGOrbModel;
	...
	sfxHandle_t	tunerSound; // EMERALD
