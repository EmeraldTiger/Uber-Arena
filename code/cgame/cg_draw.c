...
*/
#ifndef MISSIONPACK
static void CG_DrawField (int x, int y, int width, int value, int char_width, int char_height) {
	char	num[16], *ptr;
	int		l;
	int		frame;

	// EMERALD
	// 32 and 48 for all status bar numbers except weapon limits
...
//		{ 0.2, 1.0, 0.2, 1.0 } , { 1.0, 0.2, 0.2, 1.0 }, {0.5, 0.5, 0.5, 1} };
	...
	limit = ps->stats[STAT_MAXWEAPONS] + 3;
	...
	CG_DrawBigStringColor(585 - wlx, 380, s, wlcolor);
	// CG_DrawPic(370, 400, 24, 36, cgs.media.numberShaders[4]);
