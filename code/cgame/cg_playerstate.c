...
void CG_CheckLocalSounds( playerState_t *ps, playerState_t *ops ) {
	...
	if (ps->persistant[PERS_PLAYEREVENTS] != ops->persistant[PERS_PLAYEREVENTS]) {
		...
		else if ((ps->persistant[PERS_PLAYEREVENTS] & PLAYEREVENT_POISONCREDIT) !=
			(ops->persistant[PERS_PLAYEREVENTS] & PLAYEREVENT_POISONCREDIT)) {
			// CG_Printf("%s received credit for the frag of %s");
		}
		reward = qtrue;
	}
